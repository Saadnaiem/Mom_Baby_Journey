...
// --- ARABIC DATA WITH DETAILED TRANSLATIONS ---
export const JOURNEY_DATA_AR: Milestone[] = [
  {
    ...
    checklist: [
      ...
      { id: 's1-mom-5', name: 'أوميغا-3 / DHA لتهيئة الرحم', category: 'رعاية الأم والخصوبة', description: 'ضروري لصحة القلب والأوعية الدموية والسيطرة على الالتهابات.' },
  ...
  },
  {
    ...
    checklist: [
      ...
      { id: 's2-nut-3', name: 'مكملات الحديد اللطيفة', category: 'تغذية الأم الداخلية', description: 'تمنع الإصابة بفقر الدم مع زيادة تدفق حجم الدم في الجسم.' },
      { id: 's2-nut-4', name: 'الكالسيوم + فيتامين د3 للعظام', category: 'تغذية الأم الداخلية', description: 'ضروري للتطور السليم للهيكل العظمي للجنين.' },
  ...
  },
  {
    ...
    checklist: [
      ...
      { id: 's3-hosp-m3', name: 'حمالات صدر مخصصة للرضاعة الطبيعية', category: 'حقيبة المستشفى - للأم', description: 'توفر سهولة تامة للوصول ومصنوعة من خامات قطنية ناعمة.' },
      ...
      { id: 's3-hosp-b3', name: 'كريم الوقاية من طفح الحفاض والتهيج', category: 'حقيبة المستشفى - للطفل', description: 'يشكل طبقة عازلة واقية لحماية المؤخرة من الرطوبة.' },
      ...
      { id: 's3-add-1', name: 'أجهزة شفط الحليب للمواليد', category: 'الاستعداد للرضاعة الطبيعية', description: 'متاح للطلب المباشر لتسهيل تجميع الحليب للأم.' },
      { id: 's3-add-2', name: 'رضاعات التغذية وحلمات السيليكون الطبيعية', category: 'الاستعداد للتغذية', description: 'رضاعات متطورة تسمح بالتناوب بين الصدر والرضاعة.' },
      { id: 's3-add-3', name: 'شامبو لطيف ومغذي للأطفال أول يوم', category: 'مستحضرات نظافة المولود', description: 'تركيبة خالية من الدموع ومخصصة لفروة الرأس الحساسة.' },
      { id: 's3-add-4', name: 'سائل الاستحمام والترطيب للأطفال', category: 'مستحضرات نظافة المولود', description: 'غسول دافئ ومرطب يطهر بشرة المولود اللطيفة دون جفاف وبشرة نقية.' },
      { id: 's3-add-5', name: 'زيوت التدليك اللطيفة للمواليد', category: 'مستحضرات نظافة المولود', description: 'زيت طبيعي مهدئ يحبس الرطوبة ويريح عضلات طفلكِ.' },
      { id: 's3-add-6', name: 'عربات التنقل الخفيفة للمواليد الجدد', category: 'الاستعداد للحركة والتنقل', description: 'عربات فخمة مبطنة وآمنة لحركة الخروج الأولى من المشفى بكل أمان.' }
    ]
  },
  {
    ...JOURNEY_DATA[3],
    ...
    checklist: [
      ...
      { id: 's4-toil-1', name: 'شامبو شعر الرضع الملطف والخالي من الدموع', category: 'مستحضرات النظافة (الشعر والبشرة)', description: 'ينظف فروة رأس المولود بنعومة فائقة وبأمان تام للعينين.' },
      { id: 's4-toil-2', name: 'سائل غسيل واستحمام الرضع فائق النعومة', category: 'مستحضرات النظافة (الشعر والبشرة)', description: 'غسول رغوي لطيف ومغذي ينظف البشرة الحساسة بعناية ورغوة غنية.' },
      ...
      { id: 's4-toil-4', name: 'زيوت العناية وتدليك الأطفال اللطيفة', category: 'مستحضرات النظافة (الشعر والبشرة)', description: 'تزيد من مرونة الجلد وتساعد بمرحلة التدليك المهدئ قبل النوم المريح.' },
      ...
      { id: 's4-acc-1', name: 'رضاعات الحليب الطبية المضادة للغازات', category: 'مستلزمات الأطفال والسلامة', description: 'تتميز بصمامات تهوية خاصة تمنع بلع الهواء وتحد من المغص لسلامة الرضيع.' },
      { id: 's4-acc-2', name: 'أجهزة تعقيم رضاعات الأطفال البخارية', category: 'مستلزمات الأطفال والسلامة', description: 'تعقيم سريع يقضي على 99.9% من البكتيريا والجراثيم المنزلية وبأمان.' },
      ...
      { id: 's4-acc-6', name: 'أجهزة مراقبة الأطفال اللاسلكية بالصوت والصورة', category: 'مستلزمات الأطفال والسلامة', description: 'تتيح لكِ مراقبة نوم وسلامة طفلكِ عن بعد بكامل الطمأنينة عبر الشاشة.' },
  ...
  },
  {
    ...
    checklist: [
      { id: 's6-grow-1', name: 'حليب النمو للأطفال الدارجين (المرحلة الثالثة ١-٣ سنوات)', category: 'تغذية ودعم مناعة الدارجين', description: 'يدعم المتطلبات الجسدية والعقلية المتزايدة للأطفال في سن الحركة واللعب وبناء المناعة والنمو.' }
    ]
  }
];
